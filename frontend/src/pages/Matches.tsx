      ...
      {isLoading ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.profiles.map((profile: any, index: number) => {
            const profileId = profile._id || profile.id;
            const photoUrl = profile.photos?.[0] || profile.photoUrl || profile.avatarUrl;
            return (
            <div
            ...
            >
              <div className="w-full h-48 rounded-lg mb-4 overflow-hidden bg-primary-100 flex items-center justify-center">
                {photoUrl ? (
